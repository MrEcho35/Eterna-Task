...
def train_model(df: pd.DataFrame) -> Prophet:
    ...
    logger.info("Prophet model is training...")
...
def retrain_model():
    """Trains a new model and updates."""
    global model  # In order to use the model in all system
...
# To run the app write the command below to the shell:
